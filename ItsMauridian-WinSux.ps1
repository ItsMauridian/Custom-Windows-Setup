...
#   - Added: Services to Manual (CTT list, ~100 services)
...
#   - Added: winget app installs (Autoruns, Brave, Discord, EA App, EarTrumpet,
#            Epic Games Launcher, HWiNFO, iTunes, MSEdgeRedirect, Obsidian, PowerToys,
#            PuTTY, ShareX, Slack, Steam, Sublime Text, TagScanner, Telegram,
#            Windows Terminal, Ubisoft Connect, VLC, UniGetUI, WinRAR, WinSCP, Zoom)
#   - Added: Brave debloat registry keys (Rewards, Wallet, VPN, AI Chat, Stats Ping)
